...
def compute_complexity(model, input_size, verbose=False, only_conv_linear=True):
    """
    ...
    Args:
        ...
        only_conv_linear (bool, optional): only considers convolution and linear layers
        when counting flops. Default is True. If set to False, flops of all layers will be counted.
    """
    registered_handles = []
    layer_list = []
